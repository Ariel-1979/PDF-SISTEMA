...
export async function updateChofer(id, nombre) {
  ...
  try {
    ...
    console.error(`Error al actualizar chofer con ID ${id}:`, error);
...
export async function deleteChofer(id) {
  ...
  await connection.beginTransaction();
  try {
    console.log(`Intentando eliminar chofer con ID: ${id}`);
    ...
    console.error(`Error al eliminar chofer con ID ${id}:`, error);
    throw new Error(`Error al eliminar chofer: ${error.message}`);
  }
}

// Función para obtener pedidos por chofer
export async function getPedidosByChofer(nombre) {
  ...
  try {
    ...
    console.error(`Error al obtener pedidos del chofer ${nombre}:`, error);
